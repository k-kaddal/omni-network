...
export interface EthbridgeMetadata {
  index?: string;
  address?: string;
  timestamp?: string;
  blockNumber?: string;
 ...
 */
export type EthbridgeParams = object;

export interface EthbridgeQueryAllMetadataResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/k-kaddal/omni/ethbridge/metadata
   */
  queryMetadataAll = (
    query?: {
    ...
    this.request<EthbridgeQueryAllMetadataResponse, RpcStatus>({
      path: `/k-kaddal/omni/ethbridge/metadata`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/k-kaddal/omni/ethbridge/metadata/{index}
   */
  queryMetadata = (index: string, params: RequestParams = {}) =>
    this.request<EthbridgeQueryGetMetadataResponse, RpcStatus>({
      path: `/k-kaddal/omni/ethbridge/metadata/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/k-kaddal/omni/ethbridge/params
   */
